...
PLAYER_TWO_SPACESHIP_IMAGE = pygame.image.load(
    os.path.join('Assets\Ships', 'GalactixRacer.png'))
...
def main():  # Main Function
    ...
    player_one = pygame.Rect(
        WIDTH//2-PLAYER_ONE_SPACESHIP.get_width()//2, 100, SHIP_WIDTH, SHIP_HEIGHT)
    player_two = pygame.Rect(
        WIDTH//2-PLAYER_TWO_SPACESHIP.get_width()//2, HEIGHT-200, SHIP_WIDTH, SHIP_HEIGHT)
